...
/**
 * Solver is an abstract class, which contains the methods to initialize and solve models with a single class of jobs.<br>
 * 
...
public abstract class Solver {
	...
	/**
	 * array of array (i.e. matrix) containing the service rates of the service centers [station] [population]
	 */
	...
	/**
	 * array containing the residence time of each service center. residence time = time spent in queue + time spent in service
	 */
	...
	/**
	 * Initializes the solver with the model parameters. It must be called before trying to solve the model.
	 * 
	 * @param n
	 *            array of n of service centers.
	 * @param t
	 ...
	 * OLD
	 * 
	 * public String toString() { StringBuffer buf = new StringBuffer(); buf.append(getClass().getName()); buf.append("\n-------------------------");
	 * for (int i = 0; i < stations; i++) { buf.append("\nIndexes " + name[i]); buf.append("\nthroughput          : " + throughput[i]);
	 * buf.append("\nutilization         : " + utilization[i]); buf.append("\nmean queue length   : " + queueLen[i]);
	 * buf.append("\nmean residence time : " + residenceTime[i]); } buf.append("\n\nsystem throughput    : " + totThroughput);
	 * buf.append("\nsystem response time : " + totRespTime); buf.append("\nsystem users : " + totUser); return buf.toString(); }
	 */
	/**
