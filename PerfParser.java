...
//DeviceDef can be refactored to have DeviceDetail for more readablity
  static final public void DeviceDef() throws ParseException {
                     DeviceCategory devcat; Token name; String devname="";
    if (jj_2_1(3)) {
      ...
      while (true) {
        ...
        name = DeviceName();
    devname = name.image;
    Device d = new Device(devname, devcat);
    ModelParameters.inputDistSys.devices.add(d);
      }
      ...
      case DEVICE:
        ...
        devcat = DevCategory();
        name = DeviceName();
    Device d = new Device(name.image, devcat);
    ModelParameters.inputDistSys.devices.add(d);
        break;
      default:
        jj_la1[3] = jj_gen;
  ...
  static final public void HostDef() throws ParseException, DeviceNotFoundException, Exception {
                                                         Token name,n;Host h;String hostname="";
...
/**************************************************************************************/
  ...
  static final public void TaskDetail(Task t) throws ParseException {
                                DeviceCategory devcat;  Distribution dist; SoftResource res; Variable basespeed;
    if (jj_2_4(2)) {
      devcat = DevCategory();
      ...
      jj_consume_token(AT);
      basespeed = Variable();
         t.addDeviceAndServiceTime(devcat,dist, basespeed);
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case CPU:
      case IO:
        ...
        jj_consume_token(SERVT);
        dist = Distribution();
         t.addDeviceAndServiceTime(devcat,dist);
        break;
      case SOFTRES:
        res = SoftResourceDef();
                                 t.addSoftRes(res);
  ...
  static final public void SoftResDetail(SoftResource sr) throws ParseException {
                                        DeviceCategory devcat; Distribution dist; SoftResource res;Variable v;SchedulingPolicy pol; Variable basespeed;
    if (jj_2_5(2)) {
      devcat = DevCategory();
      jj_consume_token(SERVT);
      dist = Distribution();
      jj_consume_token(AT);
      basespeed = Variable();
         sr.addDeviceAndServiceTime(devcat,dist, basespeed);
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case COUNT:
        jj_consume_token(COUNT);
  ...
  static final public DeviceCategory DevCategory() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case CPU:
      jj_consume_token(CPU);
           {if (true) return DeviceCategory.CPU;}
      break;
    case IO:
      jj_consume_token(IO);
          {if (true) return DeviceCategory.IO;}
      break;
    default:
      jj_la1[39] = jj_gen;
      jj_consume_token(-1);
...
//Validations: Checks if name is already defined
  ...
  static final public Token HostName() throws ParseException {
    ...
    t = jj_consume_token(IDENTIFIER);
                hostname = t.image;
                if(ModelParameters.inputDistSys.isHost(hostname)==true)
                {if (true) throw new Error("Host "+hostname+" Line:"+t.beginLine+" Column:"+t.beginColumn +" already defined!");}
                else
                {if (true) return(t);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public Token DeviceName() throws ParseException {
                        Token t; String devname="";
    t = jj_consume_token(IDENTIFIER);
                devname = t.image;
                if(ModelParameters.inputDistSys.isDevice(devname)==true)
                {if (true) throw new Error("Device \u005c""+devname+"\u005c" Line:"+t.beginLine+" Column:"+t.beginColumn +" already defined!");}
                else
                {if (true) return(t);}
    throw new Error("Missing return statement in function");
  }
...
//Validations: checks if the give name exists
  ...
  static final public Token ValidHostName() throws ParseException {
    ...
    jj_consume_token(148);
                try{
                    hostname = t.image+"["+n.image+"]";
                        ModelParameters.inputDistSys.getHost(hostname);
                        t.image = hostname;
                        {if (true) return(t);}
                }catch (Error e)
                {{if (true) throw new Error("Undefined host \u005c""+hostname+"\u005c" Line:"+t.beginLine+" Column:"+t.beginColumn );}}
    throw new Error("Missing return statement in function");
  }
...
//Workload type parsing added by yogesh
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x281e0680,0x281e0680,0x1800,0x400,0x0,0x200,0x0,0x0,0x0,0x2000,0x0,0x0,0x0,0x0,0x0,0xd0200000,0x0,0x0,0x0,0x0,0x0,0x0,0x20001800,0x20001800,0x50201800,0x50200000,0xc000000,0x50200000,0xc000000,0x0,0x0,0x800000,0x0,0x0,0x0,0x0,0x0,0x0,0x1e000,0x1800,0x0,0x0,0x0,0x0,0x50200000,0x50200000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x1804000,0x1804000,0x0,0x0,0x0,0x0,0x0,0x800000,0xe000000,0xe0000000,0x0,0xe000000,0x4,0x40000,0x100,0x680080,0x4,0x698000,0x0,0x0,0x0,0x698000,0x0,0x0,0x0,0x0,0x18,0x20,0x18,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3e00,0x0,0x0,0x0,0x0,0x680000,0x0,0x6000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4,0x4,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40,0x0,0x0,0x0,0x40,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0xffffc000,0xffffc000,0x0,0x0,0x0,0x0,0x0,0x0,0x10,0x0,0xf,0x10,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3fe0,0x0,0x0,0x0,0xffffc000,0xffffc000,0x0,0x0,0x0,0x0,0x10,0x0,0x47c04000,0x0,0x0,0xc7c04000,0x5fffc000,0x0,0x0,0x0,0x0,0x0,0x5fffc000,0x20000000,0x0,0xffffc000,0x0,0x0,0x0,0x0,0xffffc000,0xffffc000,0xffffc000,0xffffc000,0xffffc000,0xffffc000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xffffc000,0x0,0x0,0x434000,0x0,0x0,0x0,0x434000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x1b263b,0x1b263b,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40000,0x0,0x0,0x40000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3263b,0xb,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x1,0x9,0x0,0x0,0x0,0x0,0x0,0x9,0x2,0x0,0xb,0x0,0x0,0x0,0x0,0x3263b,0x3263b,0x3263b,0x3263b,0x3263b,0xb,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xb,0x0,0x0,0x98000000,0x24000000,0x600000,0x0,0x98000000,0x40000005,0x0,0x0,0x0,0x40000005,0x43800001,0x43800001,0x0,};
   }
   private static void jj_la1_init_4() {
      jj_la1_4 = new int[] {0x209200,0x209200,0x0,0x0,0x8000,0x0,0x8000,0x0,0x0,0x0,0x0,0x0,0x8000,0x0,0x0,0x0,0x8000,0x0,0x9000,0x9000,0x9000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x8000,0x0,0x0,0x8000,0x0,0x8000,0x8000,0x9000,0x9000,0x0,0x0,0x0,0x209000,0x20b000,0x1000000,0x0,0x0,0x8000,0x0,0x8000,0x0,0x4200000,0x80000,0x0,0x0,0x8000,0x8000,0x8000,0x2400000,0x80000,0x0,0x0,0x4200000,0x0,0x800000,0x800000,0x800000,0x800000,0x209000,0x209000,0x209000,0x209000,0x209000,0x209000,0x10000000,0x20000000,0xc0000000,0xc0000000,0x0,0x0,0x1000000,0x0,0x0,0x209000,0x9000,0x200000,0x1f,0x0,0x0,0xc0,0x1f,0x0,0x9000,0x9000,0x9000,0x0,0x100,0x100,0x0,};
   }
   private static void jj_la1_init_5() {
      jj_la1_5 = new int[] {0x10,0x10,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x10,0x10,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x10,0x10,0x10,0x10,0x10,0x10,0x0,0x0,0x0,0x0,0xf,0xf,0x10,0x60,0x60,0x10,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
